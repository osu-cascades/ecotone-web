  ...
  describe '#create' do
    context 'with invalid attributes' do
      it 'does not save new lichen_sample' do
        lichen_sample_params = FactoryGirl.attributes_for(:invalid_lichen_sample)
      ...
      it 'does not redirect to index' do
        post :create, params: { lichen_sample: FactoryGirl.attributes_for(:invalid_lichen_sample) }
  ...
  describe '#update' do
    ...
    context 'with valid attributes' do
      it 'updates lichen sample attributes' do
        put :update, params: { id: @lichen_sample, lichen_sample: FactoryGirl.attributes_for(:lichen_sample, description: 'I have a lichen for you') }
      ...
      it 'redirects to the updated lichen sample' do
        put :update, params: { id: @lichen_sample, lichen_sample: FactoryGirl.attributes_for(:lichen_sample) }
    ...
    context 'with invalid attributes' do
      it 'does not update attributes' do
        put :update, params: { id: @lichen_sample, lichen_sample: FactoryGirl.attributes_for(:lichen_sample, description: nil) }
        @lichen_sample.reload
